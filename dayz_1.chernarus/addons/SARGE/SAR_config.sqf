...
SAR_DESPAWN_TIMEOUT = 900; // 2 minutes
...
KRON_UPS_searchVehicledist =1000; // 700, 900  
...
// military AI
SAR_leader_sold_list = ["Soldier1_DZ"]; // the potential classes of the leader of a soldier group
SAR_sniper_sold_list = ["Soldier1_DZ"]; // the potential classes of the snipers of a soldier group
...
SAR_sold_rifleman_weapon_list = ["M16A2","M16A2GL","M240","M4A1","M8_holo_sd","M1014","G36C","MG36"];
SAR_sold_rifleman_pistol_list = [];    

// potential item list for riflemen
SAR_sold_rifleman_items = [["ItemWaterbottle",75],["FoodMRE",60]];
SAR_sold_rifleman_tools = [["ItemMap",50],["ItemCompass",30],["ItemRadio",100]];
...
SAR_sold_sniper_items = [["ItemWaterbottle",75],["FoodCanSardines",60],["Skin_Sniper1_DZ",10],["ItemRadio",100]];
...
// potential weapon list for leaders
SAR_surv_leader_weapon_list = ["M4A1","M4A3_CCO_EP1","AK_47_M","G36a","m8_compact"];
SAR_surv_leader_pistol_list = [];   

// potential item list for leaders -> Item / Chance 1 - 100
SAR_surv_leader_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["ItemGoldBar",20],["ItemComboLock",1]];
SAR_surv_leader_tools =  [["ItemMap",50],["ItemCompass",30],["Binocular_Vector",5],["NVGoggles",5],["ItemRadio",100]];

//potential weapon list for riflemen
SAR_surv_rifleman_weapon_list = ["M4A1","M16A2","Winchester1866","AK_74","LeeEnfield","M1014","AKS_74_kobra","Mk_48"];
SAR_surv_rifleman_pistol_list = [];    

// potential item list for riflemen
SAR_surv_rifleman_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["DZ_Backpack_EP1",10]];
SAR_surv_rifleman_tools = [["ItemMap",50],["ItemCompass",30],["ItemRadio",100]];
...
SAR_surv_sniper_tools = [["ItemMap",50],["ItemCompass",30],["ItemRadio",100]];
...
// potential weapon list for leaders
SAR_band_leader_weapon_list = ["M4A1","M4A3_CCO_EP1","AK_47_M","M240_DZ","AKS_GOLD","AK_74_GL","AK_107_GL_kobra","Sa58P_EP1"];
...
//potential weapon list for riflemen
SAR_band_rifleman_weapon_list = ["FN_FAL","bizon","Winchester1866","AK_74","LeeEnfield","Saiga12K","Pecheneg","RPK_74","PK"];
SAR_band_rifleman_pistol_list = [];    

// potential item list for riflemen
SAR_band_rifleman_items = [["ItemSodaPepsi",75],["FoodCanBakedBeans",60],["ItemPainkiller",50]];
SAR_band_rifleman_tools = [["ItemMap",50],["ItemCompass",30],["Binocular_Vector",2],["ItemRadio",100]];
...
SAR_band_sniper_tools = [["ItemMap",50],["ItemCompass",30],["Binocular_Vector",10],["ItemFlashlight",100],["ItemRadio",100]];
